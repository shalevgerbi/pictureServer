...
#
#     if bbox:
#         # expand the bounding box by the line thickness
#         bbox = (bbox[0]-line_thickness, bbox[1]-line_thickness, bbox[2]+line_thickness, bbox[3]+line_thickness)
#         return image.crop(bbox)
#
#     return image
...
def get_model():
    ...
    # custom_objects={"CTCLayer": CTCLayer}) # //important!!

    # old model
    # model = load_model("C:/Users/shalev/PycharmProjects/pictureServer/my_model.h5",
    #                    custom_objects={"CTCLayer": CTCLayer})
    # new model
    model = load_model("C:/Users/shalev/PycharmProjects/pictureServer/AI/combi_G_23_21_best.h5",
                       custom_objects={"CTCLayer": CTCLayer})
...
def predict():
    ...
    if im.height < 1000 and im.width < 3000:
        ...
        im.save("C:/Users/shalev/projects/musicSheet/correctImages/alphaPic.jpg")
        # im.save("C:/Users/shalev/projects/musicSheet/correctImages/originalPic.jpg")

        im, finalAngle, maxLine = rotatePic(im)
        if type(im) == type('a'):
            im = Image.open(BytesIO(base64.b64decode(im)))
            im.save("C:/Users/shalev/projects/musicSheet/correctImages/rotatePic.jpg")
        # im = Image.open("rotated_image.jpg")
        #     im = replace_letters_and_numbers(im)
        #     im.save("C:/Users/shalev/projects/musicSheet/correctImages/noLetters.jpg")

        # im = to_grayscale(im)
        # im.save("C:/Users/shalev/projects/musicSheet/correctImages/grayscalePic.jpg")
        im = trim_borders(im)
        im.save("C:/Users/shalev/projects/musicSheet/correctImages/trimPic.jpg")
        im = pad_image(im, 30)
        im.save("C:/Users/shalev/projects/musicSheet/correctImages/padPic.jpg")
        # if finalAngle != 0:
        im, finalAngle, maxLine = rotatePic(im, prevLine=maxLine,prevAngle=finalAngle)
        if type(im) == type('a'):
            im = Image.open(BytesIO(base64.b64decode(im)))
            im.save("C:/Users/shalev/projects/musicSheet/correctImages/rotatePic2.jpg")
        im = trim_borders(im, isSecond=True)
        im.save("C:/Users/shalev/projects/musicSheet/correctImages/trimPic2.jpg")
        im = pad_image(im, 20, isLast=True)
        im.save("C:/Users/shalev/projects/musicSheet/correctImages/padPic2.jpg")
        im = resize_image(im)
        im.save("C:/Users/shalev/projects/musicSheet/correctImages/resizePic.jpg")
